...
public class VideoValidator extends Validator {
    ...
    private static final int TITLE_MAX_LEGTH = 255;
    private static final int DESCRIPTION_MAX_LEGTH = 4_000;

    private final Video video;

    protected VideoValidator(final Video aVideo, final ValidationHandler handler) {
        super(handler);
        this.video = aVideo;
    }
    ...
    private void checkDescriptionConstraints() {
        ...
        if (length > DESCRIPTION_MAX_LEGTH)
