...
public class CategoryController implements CategoryAPI {
    ...
    public ResponseEntity<?> createCategory(final CreateCategoryRequest input) {
        final var aCommand = CreateCategoryCommand.with(input.name(), input.description(), input.active() != null ? input.active() : true);
    ...
    @Override
    public Pagination<CategoryListResponse> listCategories(final String search, int page, int perPage, String sort, final String direction) {
    ...
    public ResponseEntity<?> updateById(final String id, final UpdateCategoryRequest input) {
        final var aCommand = UpdateCategoryCommand.with(id, input.name(), input.description(), input.active() != null ? input.active() : true);
