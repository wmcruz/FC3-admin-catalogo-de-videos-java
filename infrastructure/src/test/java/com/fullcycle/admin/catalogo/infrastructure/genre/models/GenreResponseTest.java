...
public class GenreResponseTest {
    ...
    public void testMarshall() throws Exception {
        ...
        final var response = new GenreResponse(expectedId, expectedName, expectedCategories, expectedIsActive, expectedCreatedAt, expectedUpdatedAt, expectedDeletedAt);
    ...
    public void testUnmarshall() throws Exception {
        ...
        final var json = """
                ...
                """.formatted(expectedId, expectedName, expectedCategory, expectedIsActive, expectedCreatedAt.toString(), expectedUpdatedAt.toString(), expectedDeletedAt.toString());
