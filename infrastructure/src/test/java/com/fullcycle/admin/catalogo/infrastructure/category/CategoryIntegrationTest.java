...
public class CategoryIntegrationTest {
    ...
    public void givenAValidCategory_whenCallsCreate_sholdReturnANewCategory() {
        ...
        Assertions.assertEquals(aCategory.getCreatedAt().truncatedTo(ChronoUnit.MINUTES), actualEntity.getCreatedAt().truncatedTo(ChronoUnit.MINUTES));
        Assertions.assertEquals(aCategory.getUpdatedAt().truncatedTo(ChronoUnit.MINUTES), actualEntity.getUpdatedAt().truncatedTo(ChronoUnit.MINUTES));
    ...
    @Test
    public void givenAPrePersistedCategoryAndValidCategoryId_whenTryToDeletedIt_shouldDeleteCategory() {
    ...
    public void givenAPrePersistedCategoryAndValidCategoryId_whenCallsFindById_shouldReturnCategory() {
        ...
        Assertions.assertEquals(expectedDescription, actualCategory.getDescription());
        Assertions.assertEquals(expectedIsActive, actualCategory.isActive());
        Assertions.assertEquals(aCategory.getCreatedAt().truncatedTo(ChronoUnit.MINUTES), actualCategory.getCreatedAt().truncatedTo(ChronoUnit.MINUTES));
        Assertions.assertEquals(aCategory.getUpdatedAt().truncatedTo(ChronoUnit.MINUTES), actualCategory.getUpdatedAt().truncatedTo(ChronoUnit.MINUTES));
        Assertions.assertEquals(aCategory.getDeletedAt(), actualCategory.getDeletedAt());
        Assertions.assertNull(actualCategory.getDeletedAt());
    }

    @Test
    public void givenValidCategoryIsNotStored_whenCallsFindById_shouldReturnEmpty() {
        Assertions.assertEquals(0, categoryRepository.count());
    ...
    @Test
    public void givenFallowPagination_whenCallsFindAllWithPage1_shouldReturnPaginated() {
        var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 3;
    ...
    @Test
    public void givenPrePersistedCategoriesAndDocAsTerms_whenCallsFindAllAndTermsMatchsCagoryName_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
    ...
    @Test
    public void givenPrePersistedCategoriesAndMaisAssistidaAsTerms_whenCallsFindAllAndTermsMatchsCagoryDescription_shouldReturnPaginated() {
        final var expectedPage = 0;
        final var expectedPerPage = 1;
        final var expectedTotal = 1;
