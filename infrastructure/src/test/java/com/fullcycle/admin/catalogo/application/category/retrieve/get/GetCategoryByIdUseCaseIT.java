...
public class GetCategoryByIdUseCaseIT {
    ...
    public void givenAValidId_whenCallsGetCategory_shouldReturnCategory() {
        ...
        assertEquals(aCategory.getCreatedAt().truncatedTo(ChronoUnit.MINUTES), actualCategory.createdAt().truncatedTo(ChronoUnit.MINUTES));
        assertEquals(aCategory.getUpdatedAt().truncatedTo(ChronoUnit.MINUTES), actualCategory.updatedAt().truncatedTo(ChronoUnit.MINUTES));
