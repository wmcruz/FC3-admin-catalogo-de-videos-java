...
public class CastMemberAPITest {
    ...
    @Test
    public void givenAInvalidName_whenCallsCreateCastMember_shoulReturnNotification() throws Exception {
        // given
    ...
    @Test
    public void givenAnInvalidName_whenCallsUpdateCastMember_shoulReturnNotification() throws Exception {
        // given
    ...
    @Test
    public void givenAnInvalidId_whenCallsUpdateCastMember_shoulReturnNotFound() throws Exception {
        // given
        final var expectedId = CastMemberID.from("123");
    ...
    @Test
    public void givenEmptyParams_whenCallListCastMembers_shouldUseDefaultsReturnIt() throws Exception {
        // given
        final var aMember = CastMember.newMember(Fixture.name(), Fixture.CastMember.type());
